...
Kode.prototype.initTemplates = function() {
  this.templates = {};
...
Kode.prototype.viewHome = function() {
  this.getAllRestaurants();
};

Kode.prototype.viewList = function(filters, filter_description) {
...
Kode.prototype.viewSetup = function() {
  var headerEl = this.renderTemplate('header-base', {
...
Kode.prototype.initReviewDialog = function() {
...
Kode.prototype.initFilterDialog = function() {
...
Kode.prototype.updateQuery = function(filters) {
...
Kode.prototype.viewRestaurant = function(id) {
  var sectionHeaderEl;
...
Kode.prototype.renderTemplate = function(id, data) {
...
Kode.prototype.render = function(el, data) {
  if (!data) {
    return;
  }
...
Kode.prototype.useModifier = function(el, selector, modifier) {
  el.querySelectorAll('[' + selector + ']').forEach(modifier);
};

Kode.prototype.getDeepItem = function(obj, path) {
...
Kode.prototype.renderRating = function(rating) {
...
Kode.prototype.renderPrice = function(price) {
...
Kode.prototype.replaceElement = function(parent, content) {
  parent.innerHTML = '';
  parent.append(content);
};

Kode.prototype.rerender = function() {
